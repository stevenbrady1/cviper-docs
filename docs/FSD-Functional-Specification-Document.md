...
|-------|----------|-----------|-----------|
| Backend Unit/Integration | pytest + pytest-xdist | 9,400+ tests, 644 files | Parallel (`-n auto --dist worksteal`) |
| Frontend Unit/Component | Vitest + React Testing Library | 5,300+ tests, 507 files | Threaded pool |
