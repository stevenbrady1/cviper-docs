...
|-------|----------|-----------|-----------|
| Backend Unit/Integration | pytest + pytest-xdist | 9,500+ tests, 645 files | Parallel (`-n auto --dist worksteal`) |
| Frontend Unit/Component | Vitest + React Testing Library | 5,400+ tests, 512 files | Threaded pool |
