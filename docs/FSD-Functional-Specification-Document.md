...
|-------|----------|-----------|-----------|
| Backend Unit/Integration | pytest + pytest-xdist | 9,400+ tests, 638 files | Parallel (`-n auto --dist worksteal`) |
| Frontend Unit/Component | Vitest + React Testing Library | 5,300+ tests, 502 files | Threaded pool |
