...
**2026-04-28 AI key/model/tier security sweep** — 8 P1/P2 fixes shipped in one day from a deep audit ([`ClaudeReports/audits/2026-04-28-audit-ai-key-model-tier-deep-dive.md`](ClaudeReports/audits/2026-04-28-audit-ai-key-model-tier-deep-dive.md)) that found ~22 issues at the edges of existing LESSON contracts (auth boundaries, transition cleanup, multi-replica state, encryption rotation). 23 backlog cards opened (CV-245 → CV-267); 8 closed below. The other 15 remain open as P1/P2/P3 follow-ups.
